...
import { ScooterListComponent } from './scooterlist/scooterlist.component';
import { ScootercreateComponent } from './scootercreate/scootercreate.component';
import { ScooterdetailsComponent } from './scooterdetails/scooterdetails.component';
import { ScooterupdateComponent } from './scooterupdate/scooterupdate.component';
...
@NgModule({
  declarations: [
    ...
    ScootercreateComponent,
    ScooterdetailsComponent,
    ScooterupdateComponent,
    ContactComponent,
  ],
  imports: [
    BrowserModule,
    ...
    RouterModule.forRoot([
      ...
      {
        path: 'scootercreate',
        component: ScootercreateComponent,
      },
      {
        ...
        path: 'scooterupdate',
        component: ScooterupdateComponent,
      },
      {
        path: 'contact',
